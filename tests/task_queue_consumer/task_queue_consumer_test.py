...
def test_task_queue_consumer_valid_host_port():
    ...
    task_queue_consumer.submit_scan_task(
        {"Records": [{"body": "mywebsitetest.com:443", "messageId": "13"}]},
        mock.MagicMock())
    expected = ({"Records": [{"body": "mywebsitetest.com:443", "messageId": "13"}],
                 'ssm_params': {'/me-once/door/tasks/me-twice/s3/results/id': 'bid'}},
                'mywebsitetest.com:443', '13')
...
def test_task_queue_consumer_invalid_host_port():
    ...
    with pytest.raises(ValueError):
        task_queue_consumer.submit_scan_task(
            {"Records": [{"body": "invalid_underscore.com:443", "messageId": "13"}]},
            mock.MagicMock())
...
def test_task_queue_consumer_no_port():
    ...
    with pytest.raises(ValueError):
        task_queue_consumer.submit_scan_task(
            {"Records": [{"body": "mywebsitetest.com", "messageId": "13"}]},
            mock.MagicMock())
